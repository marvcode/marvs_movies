...
# Next we create an instance for every movie that is included in the website.
...
braveheart = media.Movie("Braveheart", "1995",
...
about_time = media.Movie("About Time", "2013",
                         ...
                         "http://ecx.images-amazon.com/images/I/814fRqJ%2BAyL._SL1500_.jpg",
                         "https://youtu.be/T7A810duHvw")

lion_king = media.Movie("Lion King", "1994",
...
titanic = media.Movie("Titanic", "1997",
...
forest_gump = media.Movie("Forest Gump", "1994",
...
apollo_13 = media.Movie("Apollo 13", "1995",
...
raiders = media.Movie("Raiders of the Lost Ark", "1981",
...
# The following list of movies will be included in the website, I placed them in 
#    chronological order.                     
movie_list = [jaws, raiders, forest_gump, lion_king, toy_story, braveheart, apollo_13, titanic, saving_private_ryan, about_time]
